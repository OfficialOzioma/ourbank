  ...
  async loadBlockchainData(dispatch) {
    if (typeof window.ethereum !== 'undefined') {
      ...
      if (typeof accounts[0] !== 'undefined') {
        ...
        const balanceConverted = web3.utils.fromWei(balance)
        this.setState({ account: accounts[0], balance: balanceConverted, web3: web3 })
      ...
      try {
        ...
        const tokenBalanceConverted = web3.utils.fromWei(tokenBalance)
        ...
        this.setState({
          ...
          BBCbalance: tokenBalanceConverted
        })
      ...
      <div className='text-monospace'>
        ...
        <div className="container-fluid mt-5 text-center">
          <div class="card mycard">
            ...
            <div class="card-body">
              <p class="card-text">
                <table class="table table-hover table-inverse table-responsive myTable">
                  <tbody>
                    <tr>
                      <td scope="row">
                        Ganache wallet address:
                      </td>
                      <td>
